...
cloudinary.config({ 
    cloud_name:process.env.CLOUDINARY_CLOUD_NAME || "daqewugdy" , 
    api_key: process.env.CLOUDINARY_API_KEY || 526967196546828 , 
    api_secret : process.env.CLOUDINARY_API_SECRET || "FUwKP6pnoW2Nfmc_AZeJ_dubUT0"
  });
